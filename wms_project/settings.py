...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('WMS_PG_DB_NAME'),
        'HOST': os.getenv('WMS_PG_DB_HOST'),
        'USER': os.getenv('WMS_PG_DB_USER'),
        'PASSWORD': os.getenv('WMS_PG_DB_PASSWORD')
    }
}
...
AUTH_USER_MODEL = 'mini_game.User'
